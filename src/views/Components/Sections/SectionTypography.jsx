				...
				<div className={classes.container}>
						...
						<GridContainer>
							...
							<div className={classes.typo}>
								...
								<p>
									...
									culture. I am the nucleus. I think that’s a responsibility that I have, to push possibilities, to show people, this is the
					...
					<div id="images">
						...
						<GridContainer>
							...
							<GridItem xs={12} sm={2} className={classes.marginLeft}>
								<h4>Circle Raised</h4>
								<img src={image} alt="..." className={classes.imgRaised + ' ' + classes.imgRoundedCircle + ' ' + classes.imgFluid} />
							</GridItem>
						</GridContainer>
						<GridContainer />
					</div>

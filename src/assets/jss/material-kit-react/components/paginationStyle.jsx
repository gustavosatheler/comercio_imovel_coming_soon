import { grayColor, primaryColor, primaryColorRGB, infoColor, successColor, warningColor, dangerColor } from 'assets/jss/material-kit-react.jsx'
...
const paginationStyle = {
	...
	primary: {
		'&,&:hover,&:focus': {
			...
			color: '#FFFFFF',
			boxShadow: `0 4px 5px 0 rgba(${primaryColorRGB}, 0.14), 0 1px 10px 0 rgba(${primaryColorRGB}, 0.12), 0 2px 4px -1px rgba(${primaryColorRGB}, 0.2)`
		},
		'&:hover,&:focus': {
			zIndex: '2',
			cursor: 'default'
